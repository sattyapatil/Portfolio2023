                    ...
                    <div className="pesonal-info-inner">
                        ...
                        <div className="info">
                            ...
                            <div class="resume-button">
                                <Button text="Download Resume" onClick={()=>{window.open('https://drive.google.com/file/d/14wuvByA4sZMWf8-KtMdg0VjepfXzxGaM/view?usp=sharing', '_blank');}} icon={<HiArrowSmDown />} />
